...
#include <pm_config.h>
#define SLOT_SIZE ((PM_CFG_APP_SIZE - \
			CONFIG_MCUBOOT_SCRATCH_SIZE - \
			CONFIG_MCUBOOT_STORAGE_SIZE) \
			/2)
#define FLASH_AREA_IMAGE_0_OFFSET (PM_CFG_MCUBOOT_ADDRESS + PM_CFG_MCUBOOT_SIZE)
